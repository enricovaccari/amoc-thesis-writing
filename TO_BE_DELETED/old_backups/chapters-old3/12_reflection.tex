...
\chapter[Reflection on Leadership \& Personal Growth]{Reflection on Leadership\\ \& Personal Growth}
\label{ch:reflection}
...
\textls[50]{Leadership Journey · Decision-Making Under Uncertainty · Inspirational Leadership ·
Impactful Communication · Career Vectors}
\end{tabular}
}

\vspace{0.5cm}

This chapter steps back from the research to reflect on what the process asked of me as a
practitioner: how I made decisions under uncertainty, where I had to let go of ambitions,
what I learned about communicating, and where this work points next.

\section{Leadership Journey}
\label{sec:journey}

When I began this thesis, I thought leadership meant leading others. Now that I have reached the end of it, I understand that it also means leading yourself through the parts of a project that no one else has done before and no one else can do for you. My experience over these months was a mix of the two, and I have come to value both.

At the beginning I went through several iterations of the research question, partly because I was still figuring out what I truly wanted to do. I knew I wanted to create something innovative and capable of having real impact, bringing together the skills I had developed in recent years in an unconventional way. That reflects how I approach things --- I love learning, exploring, connecting ideas across fields --- and the thesis gave me the room to do it while challenging me to work through uncertainty and complexity.
...
I feel the same pull toward others who cross boundaries. Carlo Rovelli, who writes about physics as if it were poetry and never loses the science in the beauty. Michela Murgia, who used voice and presence to widen how people see, and who made a public argument out of what most people keep private. Jane Goodall, who changed a field by paying a new kind of attention, patiently, for years, and then spent her life communicating what she had seen. I am aware these can sound like different domains entirely, but I can guarantee that the underlying quality is the same: a refusal to separate deep understanding from the will to share it.
