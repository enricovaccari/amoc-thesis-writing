...
Beyond the structural verdict, the grid records specific misreadings that recur across participants and carry interpretive weight. Each is defined by what licenses the code and what excludes it, so that its application is repeatable.
