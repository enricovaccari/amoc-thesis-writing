...
Because of this feedback, the AMOC has two stable states --- vigorous overturning, and a much weaker one --- for the same conditions. A gradual push can therefore trigger an abrupt switch, and reversing the push does not simply reverse the switch.
